...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		c.Ad, c.AdClickLog, c.AdPlacement, c.Article, c.Category, c.Channel,
		c.ChannelTag, c.Comment, c.CommentLike, c.CommentReport, c.DrmKey,
		...
		c.Refund, c.Setting, c.Subscription, c.SubscriptionPlan, c.Tag, c.TagName,
		c.Tenant, c.UploadSession, c.User, c.UserSubscription, c.Wallet,
		c.WalletTransaction,
	} {
		n.Use(hooks...)
	}
...
type (
	hooks struct {
		Ad, AdClickLog, AdPlacement, Article, Category, Channel, ChannelTag, Comment,
		CommentLike, CommentReport, DrmKey, DrmLicense, DrmPolicy, EncodeProfile,
		EncodingTask, Favorite, GroupMember, History, Like, LiveChatMessage,
		LiveRecording, LiveRoom, LiveSchedule, LiveStream, Media, MediaCategory,
		MediaDrmPolicy, MediaPlaylist, MediaReport, MediaReviewLog, MediaTag,
		Notification, Order, Payment, PermissionGroup, Playlist, PortalBanner,
		PortalCustomPage, PortalNavItem, PromotionChannel, PromotionLog,
		PromotionSubscription, PromotionTask, PromotionTemplate, Refund, Setting,
		Subscription, SubscriptionPlan, Tag, TagName, Tenant, UploadSession, User,
		UserSubscription, Wallet, WalletTransaction []ent.Hook
	}
	inters struct {
		Ad, AdClickLog, AdPlacement, Article, Category, Channel, ChannelTag, Comment,
		CommentLike, CommentReport, DrmKey, DrmLicense, DrmPolicy, EncodeProfile,
		...
		PromotionSubscription, PromotionTask, PromotionTemplate, Refund, Setting,
		Subscription, SubscriptionPlan, Tag, TagName, Tenant, UploadSession, User,
		UserSubscription, Wallet, WalletTransaction []ent.Interceptor
	}
)
