...
func (_q *HistoryQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *HistoryQuery) FirstIDX(ctx context.Context) string {
...
func (_q *HistoryQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *HistoryQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *HistoryQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *HistoryQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
