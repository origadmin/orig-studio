...
func (_q *LikeQuery) QueryMedia() *MediaQuery {
...
func (_q *LikeQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *LikeQuery) FirstIDX(ctx context.Context) int {
...
func (_q *LikeQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *LikeQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *LikeQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *LikeQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *LikeQuery) WithMedia(opts ...func(*MediaQuery)) *LikeQuery {
	query := (&MediaClient{config: _q.config}).Query()
...
func (_q *LikeQuery) loadMedia(ctx context.Context, query *MediaQuery, nodes []*Like, init func(*Like), assign func(*Like, *Media)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*Like)
	for i := range nodes {
		if nodes[i].media_likes == nil {
			continue
		}
		fk := *nodes[i].media_likes
	...
	for _, n := range neighbors {
		...
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "media_likes" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
...
func (_q *LikeQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Like, init func(*Like), assign func(*Like, *User)) error {
	...
	query.Where(predicate.User(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(like.UserColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *LikeQuery) ForUpdate(opts ...sql.LockOption) *LikeQuery {
...
func (_q *LikeQuery) ForShare(opts ...sql.LockOption) *LikeQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
...
func (_q *LikeQuery) Modify(modifiers ...func(s *sql.Selector)) *LikeSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *LikeSelect) Modify(modifiers ...func(s *sql.Selector)) *LikeSelect {
