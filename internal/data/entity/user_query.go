...
func (_q *UserQuery) QueryMedia() *MediaQuery {
...
func (_q *UserQuery) QueryChannels() *ChannelQuery {
...
func (_q *UserQuery) QueryCategories() *CategoryQuery {
...
func (_q *UserQuery) QueryFavorites() *FavoriteQuery {
...
func (_q *UserQuery) WithMedia(opts ...func(*MediaQuery)) *UserQuery {
	query := (&MediaClient{config: _q.config}).Query()
...
func (_q *UserQuery) WithChannels(opts ...func(*ChannelQuery)) *UserQuery {
	query := (&ChannelClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UserQuery) WithCategories(opts ...func(*CategoryQuery)) *UserQuery {
	query := (&CategoryClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UserQuery) WithFavorites(opts ...func(*FavoriteQuery)) *UserQuery {
	query := (&FavoriteClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := _q.withFavorites; query != nil {
		if err := _q.loadFavorites(ctx, query, nodes,
			func(n *User) { n.Edges.Favorites = []*Favorite{} },
			func(n *User, e *Favorite) { n.Edges.Favorites = append(n.Edges.Favorites, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *UserQuery) loadMedia(ctx context.Context, query *MediaQuery, nodes []*User, init func(*User), assign func(*User, *Media)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(media.FieldUserID)
	}
...
func (_q *UserQuery) loadChannels(ctx context.Context, query *ChannelQuery, nodes []*User, init func(*User), assign func(*User, *Channel)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
...
func (_q *UserQuery) loadPlaylists(ctx context.Context, query *PlaylistQuery, nodes []*User, init func(*User), assign func(*User, *Playlist)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(user.PlaylistsTable)
		s.Join(joinT).On(s.C(playlist.FieldID), joinT.C(user.PlaylistsPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(user.PlaylistsPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(user.PlaylistsPrimaryKey[0]))
...
func (_q *UserQuery) loadCategories(ctx context.Context, query *CategoryQuery, nodes []*User, init func(*User), assign func(*User, *Category)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.withFKs = true
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(category.FieldUserID)
	}
...
func (_q *UserQuery) loadTags(ctx context.Context, query *TagQuery, nodes []*User, init func(*User), assign func(*User, *Tag)) error {
	...
	query.Where(func(s *sql.Selector) {
		...
		s.Join(joinT).On(s.C(tag.FieldID), joinT.C(user.TagsPrimaryKey[1]))
...
func (_q *UserQuery) loadFavorites(ctx context.Context, query *FavoriteQuery, nodes []*User, init func(*User), assign func(*User, *Favorite)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
