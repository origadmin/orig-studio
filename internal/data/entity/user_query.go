...
func (_q *UserQuery) loadMedia(ctx context.Context, query *MediaQuery, nodes []*User, init func(*User), assign func(*User, *Media)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(user.MediaTable)
		s.Join(joinT).On(s.C(media.FieldID), joinT.C(user.MediaPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(user.MediaPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(user.MediaPrimaryKey[0]))
