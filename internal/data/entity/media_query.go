...
func (_q *MediaQuery) QueryUser() *UserQuery {
...
func (_q *MediaQuery) QueryCategory() *CategoryQuery {
...
func (_q *MediaQuery) QueryComments() *CommentQuery {
...
func (_q *MediaQuery) QueryPlaylists() *MediaPlaylistQuery {
	query := (&MediaPlaylistClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *MediaQuery) QueryTagsRel() *MediaTagQuery {
...
func (_q *MediaQuery) QueryFavorites() *FavoriteQuery {
...
func (_q *MediaQuery) QueryLikes() *LikeQuery {
...
func (_q *MediaQuery) QueryReports() *MediaReportQuery {
...
func (_q *MediaQuery) WithUser(opts ...func(*UserQuery)) *MediaQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *MediaQuery) WithCategory(opts ...func(*CategoryQuery)) *MediaQuery {
	query := (&CategoryClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *MediaQuery) WithComments(opts ...func(*CommentQuery)) *MediaQuery {
	query := (&CommentClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *MediaQuery) WithPlaylists(opts ...func(*MediaPlaylistQuery)) *MediaQuery {
	query := (&MediaPlaylistClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *MediaQuery) WithTagsRel(opts ...func(*MediaTagQuery)) *MediaQuery {
	query := (&MediaTagClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *MediaQuery) WithFavorites(opts ...func(*FavoriteQuery)) *MediaQuery {
	query := (&FavoriteClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *MediaQuery) WithLikes(opts ...func(*LikeQuery)) *MediaQuery {
	query := (&LikeClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *MediaQuery) WithReports(opts ...func(*MediaReportQuery)) *MediaQuery {
	query := (&MediaReportClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *MediaQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Media, error) {
	...
	if query := _q.withCategory; query != nil {
		if err := _q.loadCategory(ctx, query, nodes, nil,
			func(n *Media, e *Category) { n.Edges.Category = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withComments; query != nil {
		if err := _q.loadComments(ctx, query, nodes,
			func(n *Media) { n.Edges.Comments = []*Comment{} },
			func(n *Media, e *Comment) { n.Edges.Comments = append(n.Edges.Comments, e) }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withPlaylists; query != nil {
		if err := _q.loadPlaylists(ctx, query, nodes,
			func(n *Media) { n.Edges.Playlists = []*MediaPlaylist{} },
			func(n *Media, e *MediaPlaylist) { n.Edges.Playlists = append(n.Edges.Playlists, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withTagsRel; query != nil {
		if err := _q.loadTagsRel(ctx, query, nodes,
			func(n *Media) { n.Edges.TagsRel = []*MediaTag{} },
			func(n *Media, e *MediaTag) { n.Edges.TagsRel = append(n.Edges.TagsRel, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withFavorites; query != nil {
		if err := _q.loadFavorites(ctx, query, nodes,
			func(n *Media) { n.Edges.Favorites = []*Favorite{} },
			func(n *Media, e *Favorite) { n.Edges.Favorites = append(n.Edges.Favorites, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *MediaQuery) loadPlaylists(ctx context.Context, query *MediaPlaylistQuery, nodes []*Media, init func(*Media), assign func(*Media, *MediaPlaylist)) error {
	...
	query.withFKs = true
	query.Where(predicate.MediaPlaylist(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(media.PlaylistsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.media_playlists
		if fk == nil {
			return fmt.Errorf(`foreign-key "media_playlists" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "media_playlists" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (_q *MediaQuery) loadReports(ctx context.Context, query *MediaReportQuery, nodes []*Media, init func(*Media), assign func(*Media, *MediaReport)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Media)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(mediareport.FieldMediaID)
	}
