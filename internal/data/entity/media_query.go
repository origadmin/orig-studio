...
func (_q *MediaQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Media, init func(*Media), assign func(*Media, *User)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(media.UserTable)
		s.Join(joinT).On(s.C(user.FieldID), joinT.C(media.UserPrimaryKey[0]))
		s.Where(sql.InValues(joinT.C(media.UserPrimaryKey[1]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(media.UserPrimaryKey[1]))
