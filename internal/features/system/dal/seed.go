...
func DefaultSettings() []*systemdto.SettingDTO {
	return []*systemdto.SettingDTO{
		...
		},
		{
			...
			Type:          systemdto.SettingTypeBool,
			Category:      systemdto.SettingCategoryStorage,
			Description:   "Keep original uploaded files after preprocessing. When disabled, original files are deleted based on the rules below.",
			FallbackValue: "true",
			IsBuiltin:     true,
		},
		{
			Key:           "keep_original_after_remux",
			Value:         "false",
			Type:          systemdto.SettingTypeBool,
			Category:      systemdto.SettingCategoryStorage,
			Description:   "Keep original file after remux (container change only, zero loss). Safe to delete since content is identical. Only effective when keep_original_files is enabled.",
			FallbackValue: "false",
			IsBuiltin:     true,
		},
		{
			Key:           "keep_original_after_transcode",
			Value:         "true",
			Type:          systemdto.SettingTypeBool,
			Category:      systemdto.SettingCategoryStorage,
			Description:   "Keep original file after transcode (re-encoding, quality loss). Recommended to keep for future re-encoding with better codecs. Only effective when keep_original_files is enabled.",
			FallbackValue: "true",
			IsBuiltin:     true,
		},
		{
		...
		},
		{
			...
			Type:          systemdto.SettingTypeString,
			Category:      systemdto.SettingCategoryPortal,
			Description:   "Site logo image URL (shown at the top-left corner; falls back to /logo.svg)",
			FallbackValue: "",
			IsBuiltin:     true,
		},
		{
			...
			Type:          systemdto.SettingTypeString,
			Category:      systemdto.SettingCategoryGeneral,
			Description:   "Review mode for new media: manual|auto",
		...
		},
		{
			...
			Type:          systemdto.SettingTypeString,
			Category:      systemdto.SettingCategoryGeneral,
			Description:   "Comment feature mode: enabled|disabled|opt_in|opt_out",
			FallbackValue: "opt_out",
			IsBuiltin:     true,
		},
		{
			Key:           "downloads_mode",
			...
			Type:          systemdto.SettingTypeString,
			Category:      systemdto.SettingCategoryGeneral,
			Description:   "Download feature mode: enabled|disabled|opt_in|opt_out",
			FallbackValue: "opt_in",
			IsBuiltin:     true,
		},
		{
		...
		},
		{
			...
			Description:   "Enable multi-tenant support (EE)",
			FallbackValue: "false",
			IsBuiltin:     true,
		},
		{
			...
			Type:          systemdto.SettingTypeBool,
			Category:      systemdto.SettingCategoryFeature,
			Description:   "Enable audit logging (EE)",
			FallbackValue: "false",
			IsBuiltin:     true,
		},
		{
			Key:           "feature_advanced_rbac",
			Value:         "false",
			Type:          systemdto.SettingTypeBool,
			Category:      systemdto.SettingCategoryFeature,
			Description:   "Enable advanced RBAC v2 (EE)",
			FallbackValue: "false",
			IsBuiltin:     true,
		},
		{
			Key:           "feature_review_workflow",
			Value:         "false",
			Type:          systemdto.SettingTypeBool,
			Category:      systemdto.SettingCategoryFeature,
			Description:   "Enable review workflow (EE)",
			FallbackValue: "false",
			IsBuiltin:     true,
		},
		{
			Key:           "feature_enterprise_notification",
			Value:         "false",
			Type:          systemdto.SettingTypeBool,
			Category:      systemdto.SettingCategoryFeature,
			Description:   "Enable enterprise notification system (EE)",
			FallbackValue: "false",
			IsBuiltin:     true,
		},
		{
			Key:           "feature_ad_system",
			Value:         "false",
			Type:          systemdto.SettingTypeBool,
			Category:      systemdto.SettingCategoryFeature,
			Description:   "Enable ad/monetization system (EE)",
			FallbackValue: "false",
			IsBuiltin:     true,
		},
		{
			Key:           "share_platforms",
			Value:         `{"twitter":true,"facebook":true,"whatsapp":true,"telegram":true,"linkedin":true,"weibo":true}`,
			Type:          systemdto.SettingTypeJSON,
			Category:      systemdto.SettingCategoryPortal,
			Description:   "Enabled link-based social share platforms for video/channel/homepage share dialogs (twitter/facebook/whatsapp/telegram/linkedin/weibo)",
			FallbackValue: `{"twitter":true,"facebook":true,"whatsapp":true,"telegram":true,"linkedin":true,"weibo":true}`,
			IsBuiltin:     true,
		},
	}
}
