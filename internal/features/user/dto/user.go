...
type UserRepo interface {
	...
	GetBySlug(context.Context, string) (*types.User, error)
	GenerateSlug(ctx context.Context, name, username string) (string, error)
	UpdateSlug(ctx context.Context, userID string, slug string) error
