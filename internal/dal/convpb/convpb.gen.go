...
type (
	...
	ChannelTag           = entity.ChannelTag
	ChannelTagEdges      = entity.ChannelTagEdges
	ChannelTags          = []*entity.ChannelTag
	...
	MediaReport          = entity.MediaReport
	MediaReportEdges     = entity.MediaReportEdges
	MediaReports         = []*entity.MediaReport
	...
	MediareportReason    = mediareport.Reason
	MediareportStatus    = mediareport.Status
	Medias               = []*entity.Media
	...
	TagNameEdges         = entity.TagNameEdges
	TagNames             = []*entity.TagName
	TagPB                = types.Tag
...
func ConvertArticlePBToArticle(from *ArticlePB) *Article {
	...
	// miss: TitleI18n            // target struct [Article] has this field, but source struct [Article] has no corresponding field
	// miss: ContentI18n          // target struct [Article] has this field, but source struct [Article] has no corresponding field
	// miss: SummaryI18n          // target struct [Article] has this field, but source struct [Article] has no corresponding field
...
func ConvertCategoryPBToCategory(from *CategoryPB) *Category {
	...
	// miss: NameI18n             // target struct [Category] has this field, but source struct [Category] has no corresponding field
	// miss: DescriptionI18n      // target struct [Category] has this field, but source struct [Category] has no corresponding field
...
func ConvertChannelPBToChannel(from *ChannelPB) *Channel {
	...
	// miss: NameI18n             // target struct [Channel] has this field, but source struct [Channel] has no corresponding field
	// miss: DescriptionI18n      // target struct [Channel] has this field, but source struct [Channel] has no corresponding field
...
func ConvertMediaPBToMedia(from *MediaPB) *Media {
	...
	// miss: TitleI18n            // target struct [Media] has this field, but source struct [Media] has no corresponding field
	// miss: DescriptionI18n      // target struct [Media] has this field, but source struct [Media] has no corresponding field
...
func ConvertTagPBToTag(from *TagPB) *Tag {
	...
	// miss: ChannelCount         // target struct [Tag] has this field, but source struct [Tag] has no corresponding field
	// miss: TitleI18n            // target struct [Tag] has this field, but source struct [Tag] has no corresponding field
	// miss: DescriptionI18n      // target struct [Tag] has this field, but source struct [Tag] has no corresponding field
