...
func (_q *ChannelQuery) QueryUser() *UserQuery {
...
func (_q *ChannelQuery) QueryMedia() *MediaQuery {
...
func (_q *ChannelQuery) QuerySubscribers() *SubscriptionQuery {
...
func (_q *ChannelQuery) WithUser(opts ...func(*UserQuery)) *ChannelQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *ChannelQuery) WithMedia(opts ...func(*MediaQuery)) *ChannelQuery {
	query := (&MediaClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ChannelQuery) WithSubscribers(opts ...func(*SubscriptionQuery)) *ChannelQuery {
	query := (&SubscriptionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ChannelQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Channel, error) {
	...
	if query := _q.withUser; query != nil {
		if err := _q.loadUser(ctx, query, nodes, nil,
			func(n *Channel, e *User) { n.Edges.User = e }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withSubscribers; query != nil {
		if err := _q.loadSubscribers(ctx, query, nodes,
			func(n *Channel) { n.Edges.Subscribers = []*Subscription{} },
			func(n *Channel, e *Subscription) { n.Edges.Subscribers = append(n.Edges.Subscribers, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *ChannelQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Channel, init func(*Channel), assign func(*Channel, *User)) error {
...
func (_q *ChannelQuery) loadSubscribers(ctx context.Context, query *SubscriptionQuery, nodes []*Channel, init func(*Channel), assign func(*Channel, *Subscription)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Channel)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.Subscription(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(channel.SubscribersColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *ChannelQuery) ForUpdate(opts ...sql.LockOption) *ChannelQuery {
...
func (_q *ChannelQuery) ForShare(opts ...sql.LockOption) *ChannelQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
